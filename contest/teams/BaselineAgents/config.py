...
# Alpha-Numeric only
TeamName = 'TheLastMinute'

# Filename.FactoryClassName (CASE-sensitive)
AgentFactory = 'agentOne.Pekachu'

Partners = ['Pengdi Xia','Yige Wang']

AgentArgs = {'Pekachu':'offense', 'Agentone':'defense'}

NotifyList = [xiapengdi@yahoo.com]
